                        ...
                        <div class="row">
                            ...
                            @foreach ($meta_info as $single_index => $value)
                                <div class="input-group mb-3">
                                    ...
                                    <div class="col-12 col-lg-2">
                                        <select wire:model.lazy="meta_info.{{ $single_index }}.ex_sub_category_id"
                                            class="form-select py-3">
                                    ...
                                    <div class="row col-md-12 my-2 input-group">
                                        @if ($single_index === 0)
                                            <button type="button" wire:click="addMetaInfoRow"
                                                class="btn btn-secondary col-12" title="Add new row">
                                                <i class='bx bxs-plus-circle display-5'></i>
                                            </button>
                                        @endif
                                        @if ($single_index != 0)
                                            <button type="button"
                                                wire:click="delMetaInfoFormRow({{ $single_index }})"
                                                class="btn btn-outline-danger col-12" title="Subtract this row">
                                                <i class='bx bxs-minus-circle display-5'></i>
                                            </button>
                                        @endif
                                    </div>
                                </div>
