<div class="container-xxl flex-grow-1 container-p-y">
    ...
    {{-- ********************************** Trashed Blog Model ***********************************  --}}
    <div wire:ignore.self class="modal fade" id="restoreModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="text-white card custom-card custom-card-has-bg" style="background-image:url('{{ asset('blog_images/' . $SingleIndex->image) }}');">
                        <div class="card-img-overlay custom-card-img-overlay d-flex flex-column">
                            <div class="card-body custom-card-body">
                                <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal" wire:click="renderDeleteModal({{ $SingleIndex->id }})" title="Delete Permanently">
                                    <i class="fa-solid fa-trash"></i>
                                </button>
                                <button type="button" class="btn btn-outline-info btn-sm" data-bs-toggle="modal" data-bs-target="#restoreModal" wire:click="renderRestoreModal({{ $SingleIndex->id }})" title="Restore">
