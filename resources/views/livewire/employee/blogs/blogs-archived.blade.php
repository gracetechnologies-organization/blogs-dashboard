<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-6">
            <h1 class="py-3 my-1">Archive Blogs</h1>
        </div>
        <div class="col-12 col-sm-6 col-md-6">
                        ...
                        <div class="card-img-overlay custom-card-img-overlay d-flex flex-column">
                            <div class="card-body custom-card-body">
                                <button type="button" class="btn btn-outline-info btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal" wire:click="renderDeleteModal(1)">
                                    <i class="fa-solid fa-trash-can-arrow-up"></i>
                                </button>
                                <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#deleteModal"
                                    wire:click="renderDeleteModal(1)">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h6 class="my-0 text-white d-block">
                                            {{--  {{ $single_index->name }}  --}} RanaWaseem
                                        </h6>
                                        <small>waseem@gmail.com
                                            {{--  {{ $single_index->email }}  --}}
                                        </small> <br>
                                        <small><i class="far fa-clock"></i> Joining:
                                            {{--  {{ $single_index->created_at }}  --}}2:3:20
                                        </small>
                                    </div>
