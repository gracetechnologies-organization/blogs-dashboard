                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        <td>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input form-checkbox-custom"
                                    value="{{ $single_index->id }}" wire:model="child_checkboxes_checked"
                                    wire:click="selectAllCheckboxes">
                            </div>
                        </td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
                                data-bs-target="#deleteModal" wire:click="renderDeleteModal({{ $single_index->id }})"
                                title="Delete">
