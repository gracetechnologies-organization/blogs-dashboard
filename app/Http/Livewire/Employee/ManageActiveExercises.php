...
class ManageActiveExercises extends Component
{
    ...
    public function mount(Request $request)
    {
        ...
        */
        ...
        $this->request_category_id = $request->cat_id;
    ...
    public function renderEditModal($id)
    {
        ...
        $relations_data = Exercise::select('exercise_relations.id as rel_id', 'exercises.id as ex_id', 'categories.id as cat_id', 'categories.name as cat_name', 'sub_categories.id as sub_cat_id', 'sub_categories.name as sub_cat_name', 'levels.id as level_id', 'levels.name as level_name', 'programs.id as program_id', 'programs.name as program_name', 'exercise_relations.from_day', 'exercise_relations.till_day')
        ...
        if ($exercise_data && $relations_data) {
            ...
            foreach ($relations_data as $singel_index => $value) {
                $this->meta_info[$singel_index] = [
                    ...
                    'ex_sub_category_id' => $value['sub_cat_id'],
        ...
        try {
            ...
            foreach ($this->meta_info as $singel_index) {
                $inserted_relations = ExerciseRelation::create([
                    ...
                    'sub_cat_id' => (!empty($singel_index['ex_sub_category_id'])) ? $singel_index['ex_sub_category_id'] : null,
        ...
        try {
            ...
            $updated = ExerciseRelation::updateOrCreate(
                ...
                [
                    ...
                    'sub_cat_id' => (!empty($this->meta_info[$index]['ex_sub_category_id'])) ? $this->meta_info[$index]['ex_sub_category_id'] : null,
    ...
    public function fillSpecificIndexOfMetaInfo(int $index, int $rel_id): void
    {
        $this->meta_info[$index] = [
            ...
            'ex_sub_category_id' => (!empty($this->meta_info[$index]['ex_sub_category_id'])) ? $this->meta_info[$index]['ex_sub_category_id'] : null,
    ...
    public function render()
    {
        ...
        return view('livewire.employee.manage-active-exercises', ['data' => $data, 'categories' => $categories, 'sub_categories' => $sub_categories, 'levels' => $levels, 'programs' => $programs]);
    }
}
